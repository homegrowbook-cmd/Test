        ...
        <div className="container mx-auto px-4 py-20 md:py-32 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <div className="mb-6 animate-fade-in">
              <span className="inline-block px-4 py-2 bg-primary-100 dark:bg-black text-primary-700 dark:text-neon-green rounded-full text-sm font-extrabold mb-4 border dark:border-neon-green/40">
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-10 leading-relaxed animate-fade-in-up animation-delay-200 font-bold">
      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="feature-card group">
            ...
            <div className="mt-4 flex items-center text-neon-green dark:text-neon-green font-extrabold group-hover:gap-2 transition-all">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          <div className="text-center p-6">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-primary-100 dark:bg-black rounded-full mb-4 border dark:border-neon-green/40">
              <svg className="w-8 h-8 text-neon-green dark:text-neon-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
              </svg>
            </div>
            <h4 className="font-extrabold text-gray-800 dark:text-white mb-2">Foto-Upload</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400 font-semibold">Unbegrenzte Fotos hochladen</p>
          </div>
          ...
          <div className="text-center p-6">
            ...
            <h4 className="font-extrabold text-gray-800 dark:text-white mb-2">Kommentare</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400 font-semibold">Feedback von der Community</p>
          </div>
          ...
          <div className="text-center p-6">
            ...
            <h4 className="font-extrabold text-gray-800 dark:text-white mb-2">Likes & Follows</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400 font-semibold">Vernetze dich mit Growern</p>
          </div>
          ...
          <div className="text-center p-6">
            ...
            <h4 className="font-extrabold text-gray-800 dark:text-white mb-2">Trending</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400 font-semibold">Entdecke beliebte Grows</p>
          </div>
        </div>
      </div>
      ...
      <div className="stats-section relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-20 relative z-10">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-extrabold text-white dark:text-neon-green mb-4">
              Join unserer wachsenden Community
            </h2>
            <p className="text-xl text-white/90 dark:text-gray-300 font-bold">
              Tausende Grower vertrauen bereits auf homegrowbook
            </p>
          </div>
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div className="stat-card">
              <div className="text-5xl md:text-6xl font-black text-white dark:text-neon-green mb-2 stat-number">1000+</div>
              <div className="text-lg text-white/90 dark:text-gray-300 font-extrabold">Aktive Grower</div>
            </div>
            <div className="stat-card">
              <div className="text-5xl md:text-6xl font-black text-white dark:text-neon-green mb-2 stat-number">5000+</div>
              <div className="text-lg text-white/90 dark:text-gray-300 font-extrabold">Grow Tagebücher</div>
            </div>
            <div className="stat-card">
              <div className="text-5xl md:text-6xl font-black text-white dark:text-neon-green mb-2 stat-number">50000+</div>
              <div className="text-lg text-white/90 dark:text-gray-300 font-extrabold">Einträge</div>
            </div>
            <div className="stat-card">
              <div className="text-5xl md:text-6xl font-black text-white dark:text-neon-green mb-2 stat-number">200+</div>
              <div className="text-lg text-white/90 dark:text-gray-300 font-extrabold">Sorten</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="cta-card max-w-4xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto font-bold">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Link href="/runs" className="text-gray-600 dark:text-neon-green hover:text-neon-green dark:hover:text-neon-lime font-extrabold transition-colors flex items-center">
