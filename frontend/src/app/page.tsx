        ...
        <div className="container mx-auto px-4 py-20 md:py-32 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-5xl md:text-7xl font-extrabold mb-6 leading-tight animate-fade-in-up">
              <span className="bg-gradient-to-r from-primary-600 via-green-500 to-primary-600 bg-clip-text text-transparent">
                Deine Grows
              </span>
              <br />
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-10 leading-relaxed animate-fade-in-up animation-delay-200">
      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="feature-card group">
            ...
            <h3 className="text-2xl font-bold mb-3 text-gray-800 dark:text-white">Grow-Tagebuch</h3>
            ...
            <div className="mt-4 flex items-center text-primary-600 dark:text-primary-400 font-semibold group-hover:gap-2 transition-all">
          ...
          <div className="feature-card group">
            ...
            <h3 className="text-2xl font-bold mb-3 text-gray-800 dark:text-white">Messungen tracken</h3>
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
          ...
          <div className="feature-card group">
            ...
            <h3 className="text-2xl font-bold mb-3 text-gray-800 dark:text-white">Community</h3>
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          <div className="text-center p-6">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">Unbegrenzte Fotos hochladen</p>
          </div>
          ...
          <div className="text-center p-6">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">Feedback von der Community</p>
          </div>
          ...
          <div className="text-center p-6">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">Vernetze dich mit Growern</p>
          </div>
          ...
          <div className="text-center p-6">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">Entdecke beliebte Grows</p>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 py-20 relative z-10">
          ...
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div className="stat-card">
              <div className="text-5xl md:text-6xl font-extrabold text-white mb-2 stat-number">1000+</div>
              <div className="text-lg text-white/90 font-medium">Aktive Grower</div>
            </div>
            <div className="stat-card">
              <div className="text-5xl md:text-6xl font-extrabold text-white mb-2 stat-number">5000+</div>
              <div className="text-lg text-white/90 font-medium">Grow Tagebücher</div>
            </div>
            <div className="stat-card">
              <div className="text-5xl md:text-6xl font-extrabold text-white mb-2 stat-number">50000+</div>
              <div className="text-lg text-white/90 font-medium">Einträge</div>
            </div>
            <div className="stat-card">
              <div className="text-5xl md:text-6xl font-extrabold text-white mb-2 stat-number">200+</div>
              <div className="text-lg text-white/90 font-medium">Sorten</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="cta-card max-w-4xl mx-auto">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Link href="/runs" className="text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 font-semibold transition-colors flex items-center">
